/*
 *  Minimal dependency-free test harness for the Arstro ImageProcessing library
 *  (copied from the DSP library's unittest/MiniTest.h so the tests build anywhere
 *  — the platform-independence goal). Usage:
 *
...
#define MINITEST_MAIN int main() { return mini::runAll(); }
