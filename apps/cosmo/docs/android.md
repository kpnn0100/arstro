...
- **Reused unchanged:** the ImageProcessing engine, `apps/cosmo/core` (`EditSession`/`History`/
...
- **New code:** `apps/cosmo/android/` (host + build) and `apps/cosmo/touch/` (the `arstro::cosmo_touch`
