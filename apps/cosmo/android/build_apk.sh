...
cp "$FDIR/Roboto/Roboto-Regular.ttf"        "$STAGE/assets/fonts/"
cp "$FDIR/Roboto/Roboto-Medium.ttf"         "$STAGE/assets/fonts/"
cp "$FDIR/Roboto/Roboto-SemiBold.ttf"       "$STAGE/assets/fonts/"
